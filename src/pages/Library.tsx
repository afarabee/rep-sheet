...
export default function Library() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* ── Header Bar ── */}
      <div className="sticky top-0 z-10 bg-background border-b border-border px-8 py-5 flex items-center gap-4">
      ...
      {/* ── Filter Bar ── */}
      <div className="sticky top-[73px] z-10 bg-background border-b border-border px-8 pt-3 pb-3 flex flex-col gap-2">
        {/* Muscle group chips */}
