...
function NumericInput({ label, value, onChange, step, placeholder }: {
  label: string; value: string; onChange: (v: string) => void; step: number; placeholder?: string
}) {
              ...
              {!isCurrentComplete && (
                <div className="bg-card border border-border rounded-2xl p-7 mb-5">
                  ...
                  <div className="flex gap-6 items-end">
                    ...
                    <NumericInput label={isCount ? 'Count' : isTimed ? 'Time (sec)' : 'Reps'} value={repsInput} onChange={setRepsInput} step={isTimed ? 5 : 1} placeholder={isCount ? '10' : isTimed ? '30' : '5'} />
                    <button
